...
struct UnregisteredUserView: View {
    ...
    //                    }
    //                    .hidden()
                Text("Crie uma conta para personalizar a app com as suas linhas e paragens favoritas.")
                    .font(.headline)
                ...
                Group {
                    ...
                    Text("Ao iniciar sessão mollit commodo incididunt commodo reprehenderit amet est officia exercitation tempor.")
                        .bold()
                        .font(.caption)
